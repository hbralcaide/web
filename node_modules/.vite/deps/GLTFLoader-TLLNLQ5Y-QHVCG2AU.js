...
// node_modules/@mappedin/mappedin-js/lib/esm/GLTFLoader-TLLNLQ5Y.js
$i();
var St = class extends kn {
  constructor(t) {
  ...
  load(t, e, r, n) {
    ...
    if (this.resourcePath !== "") i = this.resourcePath;
      ...
      let c = vl.extractUrlBase(t);
      i = vl.resolveURL(c, this.path);
    } else i = vl.extractUrlBase(t);
  ...
  parse(t, e, r, n) {
    ...
    else if (t instanceof ArrayBuffer) if (o.decode(new Uint8Array(t, 0, 4)) === bt) {
      try {
        i[A.KHR_BINARY_GLTF] = new Le(t);
      } catch (u) {
        n && n(u);
        return;
      }
    ...
    let c = new He(s, { path: e || this.resourcePath || "", crossOrigin: this.crossOrigin, requestHeader: this.requestHeader, manager: this.manager, ktx2Loader: this.ktx2Loader, meshoptDecoder: this.meshoptDecoder });
...
var fe = class {
  ...
  _loadLight(t) {
    ...
    if (n) return n;
    let s = e.json, o = ((s.extensions && s.extensions[this.name] || {}).lights || [])[t], c, l = new Nt(16777215);
    o.color !== void 0 && l.setRGB(o.color[0], o.color[1], o.color[2], ni);
    let u = o.range !== void 0 ? o.range : 0;
    switch (o.type) {
      case "directional":
        c = new _l(l), c.target.position.set(0, 0, -1), c.add(c.target);
        break;
      case "point":
        c = new ml(l), c.distance = u;
        break;
      case "spot":
  ...
  createNodeAttachment(t) {
    let e = this, r = this.parser, s = r.json.nodes[t], a = (s.extensions && s.extensions[this.name] || {}).light;
...
var de2 = class {
  ...
  extendParams(t, e, r) {
    let n = [];
    t.color = new Nt(1, 1, 1), t.opacity = 1;
    let s = e.pbrMetallicRoughness;
    if (s) {
      if (Array.isArray(s.baseColorFactor)) {
        let i = s.baseColorFactor;
        t.color.setRGB(i[0], i[1], i[2], ni), t.opacity = i[3];
      }
      s.baseColorTexture !== void 0 && n.push(r.assignTexture(t, "map", s.baseColorTexture, ke));
    }
...
var pe = class {
  ...
  getMaterialType(t) {
    ...
    return !r.extensions || !r.extensions[this.name] ? null : al;
  }
  extendMaterialParams(t, e) {
    ...
    if (i.clearcoatFactor !== void 0 && (e.clearcoat = i.clearcoatFactor), i.clearcoatTexture !== void 0 && s.push(r.assignTexture(e, "clearcoatMap", i.clearcoatTexture)), i.clearcoatRoughnessFactor !== void 0 && (e.clearcoatRoughness = i.clearcoatRoughnessFactor), i.clearcoatRoughnessTexture !== void 0 && s.push(r.assignTexture(e, "clearcoatRoughnessMap", i.clearcoatRoughnessTexture)), i.clearcoatNormalTexture !== void 0 && (s.push(r.assignTexture(e, "clearcoatNormalMap", i.clearcoatNormalTexture)), i.clearcoatNormalTexture.scale !== void 0)) {
      ...
      e.clearcoatNormalScale = new at(a, a);
    }
...
var ge2 = class {
  ...
  extendMaterialParams(t, e) {
    ...
    if (!n.extensions || !n.extensions[this.name]) return Promise.resolve();
    let s = [];
    e.sheenColor = new Nt(0, 0, 0), e.sheenRoughness = 0, e.sheen = 1;
    let i = n.extensions[this.name];
    if (i.sheenColorFactor !== void 0) {
      let a = i.sheenColorFactor;
      e.sheenColor.setRGB(a[0], a[1], a[2], ni);
    }
    return i.sheenRoughnessFactor !== void 0 && (e.sheenRoughness = i.sheenRoughnessFactor), i.sheenColorTexture !== void 0 && s.push(r.assignTexture(e, "sheenColorMap", i.sheenColorTexture, ke)), i.sheenRoughnessTexture !== void 0 && s.push(r.assignTexture(e, "sheenRoughnessMap", i.sheenRoughnessTexture)), Promise.all(s);
  }
};
var Te2 = class {
  constructor(t) {
...
var Re = class {
  ...
  extendMaterialParams(t, e) {
    ...
    return e.attenuationColor = new Nt().setRGB(a[0], a[1], a[2], ni), Promise.all(s);
  }
};
var _e = class {
  constructor(t) {
...
var xe2 = class {
  ...
  extendMaterialParams(t, e) {
    ...
    return e.specularColor = new Nt().setRGB(a[0], a[1], a[2], ni), i.specularColorTexture !== void 0 && s.push(r.assignTexture(e, "specularColorMap", i.specularColorTexture, ke)), Promise.all(s);
  }
};
var Ee2 = class {
  constructor(t) {
...
var we = class {
  ...
  loadTexture(t) {
    ...
    let i = s.extensions[e], a = n.images[i.source], o = r.textureLoader;
    if (a.uri) {
      let c = r.options.manager.getHandler(a.uri);
      c !== null && (o = c);
    }
...
var be = class {
  ...
  createNodeMesh(t) {
    ...
    for (let c of n.primitives) if (c.mode !== E.TRIANGLES && c.mode !== E.TRIANGLE_STRIP && c.mode !== E.TRIANGLE_FAN && c.mode !== void 0) return null;
    let i = r.extensions[this.name].attributes, a = [], o = {};
    ...
    return a.length < 1 ? null : (a.push(this.parser.createNodeMesh(t)), Promise.all(a).then((c) => {
      let l = c.pop(), u = l.isGroup ? l.children : [l], f = c[0].count, h = [];
      for (let m of u) {
        let T = new kt(), p = new C(), g = new bn(), _ = new C(1, 1, 1), x = new Yo(m.geometry, m.material, f);
        for (let R2 = 0; R2 < f; R2++) o.TRANSLATION && p.fromBufferAttribute(o.TRANSLATION, R2), o.ROTATION && g.fromBufferAttribute(o.ROTATION, R2), o.SCALE && _.fromBufferAttribute(o.SCALE, R2), x.setMatrixAt(R2, T.compose(p, g, _));
        for (let R2 in o) if (R2 === "_COLOR_0") {
          let w = o[R2];
          x.instanceColor = new vs(w.array, w.itemSize, w.normalized);
        } else R2 !== "TRANSLATION" && R2 !== "ROTATION" && R2 !== "SCALE" && m.geometry.setAttribute(R2, o[R2]);
        de.prototype.copy.call(x, m), this.parser.assignFinalMaterial(x), h.push(x);
      }
...
var Le = class {
  constructor(t) {
    ...
    let e = new DataView(t, 0, U), r = new TextDecoder();
    if (this.header = { magic: r.decode(new Uint8Array(t.slice(0, 4))), version: e.getUint32(4, true), length: e.getUint32(8, true) }, this.header.magic !== bt) throw new Error("THREE.GLTFLoader: Unsupported glTF-Binary header.");
    if (this.header.version < 2) throw new Error("THREE.GLTFLoader: Legacy binary file detected.");
    let n = this.header.length - U, s = new DataView(t, U), i = 0;
    for (; i < n; ) {
      let a = s.getUint32(i, true);
      i += 4;
      let o = s.getUint32(i, true);
      if (i += 4, o === yt.JSON) {
        let c = new Uint8Array(t, U + i, a);
...
var Ie2 = class {
  ...
  decodePrimitive(t, e) {
    let r = this.json, n = this.dracoLoader, s = t.extensions[this.name].bufferView, i = t.extensions[this.name].attributes, a = {}, o = {}, c = {};
    for (let l in i) {
      let u = Pe[l] || l.toLowerCase();
      a[u] = i[l];
    }
    for (let l in t.attributes) {
      let u = Pe[l] || l.toLowerCase();
      if (i[l] !== void 0) {
        let f = r.accessors[t.attributes[l]], h = B[f.componentType];
        c[u] = h.name, o[u] = f.normalized === true;
      }
    }
    return e.getDependency("bufferView", s).then(function(l) {
      return new Promise(function(u, f) {
        n.decodeDracoFile(l, function(h) {
          for (let m in h.attributes) {
            let T = h.attributes[m], p = o[m];
...
var z = class extends ai {
  ...
  interpolate_(t, e, r, n) {
    let s = this.resultBuffer, i = this.sampleValues, a = this.valueSize, o = a * 2, c = a * 3, l = n - e, u = (r - e) / l, f = u * u, h = f * u, m = t * c, T = m - c, p = -2 * h + 3 * f, g = h - f, _ = 1 - p, x = g - f + u;
    for (let R2 = 0; R2 !== a; R2++) {
      let w = i[T + R2 + a], b = i[T + R2 + o] * l, S = i[m + R2 + a], v = i[m + R2] * l;
      s[R2] = _ * w + x * b + p * S + g * v;
    }
    return s;
  }
};
...
var De = class extends z {
  interpolate_(t, e, r, n) {
    ...
    return It.fromArray(s).normalize().toArray(s), s;
  }
};
var E = { FLOAT: 5126, FLOAT_MAT3: 35675, FLOAT_MAT4: 35676, FLOAT_VEC2: 35664, FLOAT_VEC3: 35665, FLOAT_VEC4: 35666, LINEAR: 9729, REPEAT: 10497, SAMPLER_2D: 35678, POINTS: 0, LINES: 1, LINE_LOOP: 2, LINE_STRIP: 3, TRIANGLES: 4, TRIANGLE_STRIP: 5, TRIANGLE_FAN: 6, UNSIGNED_BYTE: 5121, UNSIGNED_SHORT: 5123 };
var B = { 5120: Int8Array, 5121: Uint8Array, 5122: Int16Array, 5123: Uint16Array, 5125: Uint32Array, 5126: Float32Array };
var wt = { 9728: Ne, 9729: tn, 9984: Gh, 9985: ga, 9986: Os, 9987: Vn };
var Nt2 = { 33071: Fn, 33648: Rr, 10497: Cr };
var ce = { SCALAR: 1, VEC2: 2, VEC3: 3, VEC4: 4, MAT2: 4, MAT3: 9, MAT4: 16 };
var Pe = { POSITION: "position", NORMAL: "normal", TANGENT: "tangent", TEXCOORD_0: "uv", TEXCOORD_1: "uv1", TEXCOORD_2: "uv2", TEXCOORD_3: "uv3", COLOR_0: "color", WEIGHTS_0: "skinWeight", JOINTS_0: "skinIndex" };
var O = { scale: "scale", translation: "position", rotation: "quaternion", weights: "morphTargetInfluences" };
var Ot = { CUBICSPLINE: void 0, LINEAR: Ir, STEP: cs };
var ue = { OPAQUE: "OPAQUE", MASK: "MASK", BLEND: "BLEND" };
function Ct(d) {
  return d.DefaultMaterial === void 0 && (d.DefaultMaterial = new Jr({ color: 16777215, emissive: 0, metalness: 1, roughness: 1, transparent: false, depthTest: true, side: Mn })), d.DefaultMaterial;
}
function D(d, t, e) {
  for (let r in e.extensions) d[r] === void 0 && (t.userData.gltfExtensions = t.userData.gltfExtensions || {}, t.userData.gltfExtensions[r] = e.extensions[r]);
}
function M(d, t) {
...
function Dt(d, t, e) {
  ...
  for (let c = 0, l = t.length; c < l; c++) {
    let u = t[c];
    if (r) {
      let f = u.POSITION !== void 0 ? e.getDependency("accessor", u.POSITION) : d.attributes.position;
      i.push(f);
    }
    if (n) {
      let f = u.NORMAL !== void 0 ? e.getDependency("accessor", u.NORMAL) : d.attributes.normal;
      a.push(f);
    }
    if (s) {
      let f = u.COLOR_0 !== void 0 ? e.getDependency("accessor", u.COLOR_0) : d.attributes.color;
      o.push(f);
    }
  }
  return Promise.all([Promise.all(i), Promise.all(a), Promise.all(o)]).then(function(c) {
    let l = c[0], u = c[1], f = c[2];
    return r && (d.morphAttributes.position = l), n && (d.morphAttributes.normal = u), s && (d.morphAttributes.color = f), d.morphTargetsRelative = true, d;
  });
}
function Pt(d, t) {
  if (d.updateMorphTargets(), t.weights !== void 0) for (let e = 0, r = t.weights.length; e < r; e++) d.morphTargetInfluences[e] = t.weights[e];
  if (t.extras && Array.isArray(t.extras.targetNames)) {
    let e = t.extras.targetNames;
    if (d.morphTargetInfluences.length === e.length) {
      d.morphTargetDictionary = {};
      for (let r = 0, n = e.length; r < n; r++) d.morphTargetDictionary[e[r]] = r;
    } else console.warn("THREE.GLTFLoader: Invalid extras.targetNames length. Ignoring names.");
  }
}
function kt2(d) {
  let t, e = d.extensions && d.extensions[A.KHR_DRACO_MESH_COMPRESSION];
  if (e ? t = "draco:" + e.bufferView + ":" + e.indices + ":" + le(e.attributes) : t = d.indices + ":" + le(d.attributes) + ":" + d.mode, d.targets !== void 0) for (let r = 0, n = d.targets.length; r < n; r++) t += ":" + le(d.targets[r]);
  return t;
}
function le(d) {
  let t = "", e = Object.keys(d).sort();
  for (let r = 0, n = e.length; r < n; r++) t += e[r] + ":" + d[e[r]] + ";";
  return t;
}
function ke2(d) {
  switch (d) {
...
var He = class {
  constructor(t = {}, e = {}) {
    this.json = t, this.extensions = {}, this.plugins = {}, this.options = e, this.cache = new Lt(), this.associations = /* @__PURE__ */ new Map(), this.primitiveCache = {}, this.nodeCache = {}, this.meshCache = { refs: {}, uses: {} }, this.cameraCache = { refs: {}, uses: {} }, this.lightCache = { refs: {}, uses: {} }, this.sourceCache = {}, this.textureCache = {}, this.nodeNamesUsed = {};
    let r = false, n = -1, s = false, i = -1;
    if (typeof navigator < "u") {
      let a = navigator.userAgent;
      r = /^((?!chrome|android).)*safari/i.test(a) === true;
      let o = a.match(/Version\/(\d+)/);
      n = r && o ? parseInt(o[1], 10) : -1, s = a.indexOf("Firefox") > -1, i = s ? a.match(/Firefox\/([0-9]+)\./)[1] : -1;
    }
    typeof createImageBitmap > "u" || r && n < 17 || s && i < 98 ? this.textureLoader = new ul(this.options.manager) : this.textureLoader = new Ml(this.options.manager), this.textureLoader.setCrossOrigin(this.options.crossOrigin), this.textureLoader.setRequestHeader(this.options.requestHeader), this.fileLoader = new hl(this.options.manager), this.fileLoader.setResponseType("arraybuffer"), this.options.crossOrigin === "use-credentials" && this.fileLoader.setWithCredentials(true);
  }
  setExtensions(t) {
    this.extensions = t;
  }
  ...
  parse(t, e) {
    ...
    this.cache.removeAll(), this.nodeCache = {}, this._invokeAll(function(i) {
      ...
      let a = { scene: i[0][n.scene || 0], scenes: i[0], animations: i[1], cameras: i[2], asset: n.asset, parser: r, userData: {} };
      return D(s, a, n), M(a, n), Promise.all(r._invokeAll(function(o) {
  ...
  loadBuffer(t) {
    ...
    if (e.uri === void 0 && t === 0) return Promise.resolve(this.extensions[A.KHR_BINARY_GLTF].body);
    let n = this.options;
    return new Promise(function(s, i) {
      r.load(vl.resolveURL(e.uri, n.path), s, void 0, function() {
  ...
  loadAccessor(t) {
    ...
    if (n.bufferView === void 0 && n.sparse === void 0) {
      let i = ce[n.type], a = B[n.componentType], o = n.normalized === true, c = new a(n.count * i);
      return Promise.resolve(new xe(c, i, o));
    }
    let s = [];
    return n.bufferView !== void 0 ? s.push(this.getDependency("bufferView", n.bufferView)) : s.push(null), n.sparse !== void 0 && (s.push(this.getDependency("bufferView", n.sparse.indices.bufferView)), s.push(this.getDependency("bufferView", n.sparse.values.bufferView))), Promise.all(s).then(function(i) {
      let a = i[0], o = ce[n.type], c = B[n.componentType], l = c.BYTES_PER_ELEMENT, u = l * o, f = n.byteOffset || 0, h = n.bufferView !== void 0 ? r.bufferViews[n.bufferView].byteStride : void 0, m = n.normalized === true, T, p;
      if (h && h !== u) {
        let g = Math.floor(f / h), _ = "InterleavedBuffer:" + n.bufferView + ":" + n.componentType + ":" + g + ":" + n.count, x = e.cache.get(_);
        x || (T = new c(a, g * h, n.count * h / l), x = new Go(T, h / l), e.cache.add(_, x)), p = new Wo(x, o, f % h / l, m);
      } else a === null ? T = new c(n.count * o) : T = new c(a, f, n.count * o), p = new xe(T, o, m);
      if (n.sparse !== void 0) {
        let g = ce.SCALAR, _ = B[n.sparse.indices.componentType], x = n.sparse.indices.byteOffset || 0, R2 = n.sparse.values.byteOffset || 0, w = new _(i[1], x, n.sparse.count * g), b = new c(i[2], R2, n.sparse.count * o);
        a !== null && (p = new xe(p.array.slice(), p.itemSize, p.normalized)), p.normalized = false;
        for (let S = 0, v = w.length; S < v; S++) {
          let L = w[S];
          if (p.setX(L, b[S * o]), o >= 2 && p.setY(L, b[S * o + 1]), o >= 3 && p.setZ(L, b[S * o + 2]), o >= 4 && p.setW(L, b[S * o + 3]), o >= 5) throw new Error("THREE.GLTFLoader: Unsupported itemSize in sparse BufferAttribute.");
        }
        p.normalized = m;
      }
      return p;
  ...
  loadTexture(t) {
    let e = this.json, r = this.options, s = e.textures[t].source, i = e.images[s], a = this.textureLoader;
    if (i.uri) {
  ...
  loadTextureImage(t, e, r) {
    ...
    let c = this.loadImageSource(e, r).then(function(l) {
      ...
      return l.magFilter = wt[f.magFilter] || tn, l.minFilter = wt[f.minFilter] || Vn, l.wrapS = Nt2[f.wrapS] || Cr, l.wrapT = Nt2[f.wrapT] || Cr, l.generateMipmaps = !l.isCompressedTexture && l.minFilter !== Ne && l.minFilter !== tn, n.associations.set(l, { textures: t }), l;
    }).catch(function() {
      return null;
    });
  ...
  loadImageSource(t, e) {
    ...
    let l = Promise.resolve(o).then(function(u) {
      return new Promise(function(f, h) {
        let m = f;
        e.isImageBitmapLoader === true && (m = function(T) {
          let p = new Ae(T);
          p.needsUpdate = true, f(p);
        }), e.load(vl.resolveURL(u, s.path), m, void 0, h);
      });
    }).then(function(u) {
      return c === true && a.revokeObjectURL(o), M(u, i), u.userData.mimeType = i.mimeType || Ht(i.uri), u;
    }).catch(function(u) {
  ...
  assignTexture(t, e, r, n) {
    ...
    return this.getDependency("texture", r.index).then(function(i) {
      ...
      if (r.texCoord !== void 0 && r.texCoord > 0 && (i = i.clone(), i.channel = r.texCoord), s.extensions[A.KHR_TEXTURE_TRANSFORM]) {
        let a = r.extensions !== void 0 ? r.extensions[A.KHR_TEXTURE_TRANSFORM] : void 0;
        if (a) {
  ...
  assignFinalMaterial(t) {
    ...
    if (t.isPoints) {
      let a = "PointsMaterial:" + r.uuid, o = this.cache.get(a);
      o || (o = new Vr(), en.prototype.copy.call(o, r), o.color.copy(r.color), o.map = r.map, o.sizeAttenuation = false, this.cache.add(a, o)), r = o;
    } else if (t.isLine) {
      let a = "LineBasicMaterial:" + r.uuid, o = this.cache.get(a);
      o || (o = new ys(), en.prototype.copy.call(o, r), o.color.copy(r.color), o.map = r.map, this.cache.add(a, o)), r = o;
    }
    if (n || s || i) {
      let a = "ClonedMaterial:" + r.uuid + ":";
      n && (a += "derivative-tangents:"), s && (a += "vertex-colors:"), i && (a += "flat-shading:");
      let o = this.cache.get(a);
      o || (o = r.clone(), s && (o.vertexColors = true), i && (o.flatShading = true), n && (o.normalScale && (o.normalScale.y *= -1), o.clearcoatNormalScale && (o.clearcoatNormalScale.y *= -1)), this.cache.add(a, o), this.associations.set(o, this.associations.get(r))), r = o;
    }
    t.material = r;
  }
  getMaterialType() {
  ...
  loadMaterial(t) {
    let e = this, r = this.json, n = this.extensions, s = r.materials[t], i, a = {}, o = s.extensions || {}, c = [];
    if (o[A.KHR_MATERIALS_UNLIT]) {
      let u = n[A.KHR_MATERIALS_UNLIT];
      i = u.getMaterialType(), c.push(u.extendParams(a, s, e));
    } else {
      let u = s.pbrMetallicRoughness || {};
      if (a.color = new Nt(1, 1, 1), a.opacity = 1, Array.isArray(u.baseColorFactor)) {
        let f = u.baseColorFactor;
        a.color.setRGB(f[0], f[1], f[2], ni), a.opacity = f[3];
      }
    ...
    s.doubleSided === true && (a.side = ln);
    let l = s.alphaMode || ue.OPAQUE;
    if (l === ue.BLEND ? (a.transparent = true, a.depthWrite = false) : (a.transparent = false, l === ue.MASK && (a.alphaTest = s.alphaCutoff !== void 0 ? s.alphaCutoff : 0.5)), s.normalTexture !== void 0 && i !== ps && (c.push(e.assignTexture(a, "normalMap", s.normalTexture)), a.normalScale = new at(1, 1), s.normalTexture.scale !== void 0)) {
      let u = s.normalTexture.scale;
      a.normalScale.set(u, u);
    }
    if (s.occlusionTexture !== void 0 && i !== ps && (c.push(e.assignTexture(a, "aoMap", s.occlusionTexture)), s.occlusionTexture.strength !== void 0 && (a.aoMapIntensity = s.occlusionTexture.strength)), s.emissiveFactor !== void 0 && i !== ps) {
      let u = s.emissiveFactor;
      a.emissive = new Nt().setRGB(u[0], u[1], u[2], ni);
    }
    return s.emissiveTexture !== void 0 && i !== ps && c.push(e.assignTexture(a, "emissiveMap", s.emissiveTexture, ke)), Promise.all(c).then(function() {
      let u = new i(a);
      return s.name && (u.name = s.name), M(u, s), e.associations.set(u, { materials: t }), s.extensions && D(n, u, s), u;
    });
  }
  createUniqueName(t) {
    let e = se.sanitizeNodeName(t || "");
  ...
  loadGeometries(t) {
    ...
    for (let a = 0, o = t.length; a < o; a++) {
      let c = t[a], l = kt2(c), u = n[l];
      if (u) i.push(u.promise);
      else {
        let f;
        c.extensions && c.extensions[A.KHR_DRACO_MESH_COMPRESSION] ? f = s(c) : f = Mt(new ge(), c, e), n[l] = { primitive: c, promise: f }, i.push(f);
      }
    }
    return Promise.all(i);
  }
  loadMesh(t) {
    let e = this, r = this.json, n = this.extensions, s = r.meshes[t], i = s.primitives, a = [];
    for (let o = 0, c = i.length; o < c; o++) {
      let l = i[o].material === void 0 ? Ct(this.cache) : this.getDependency("material", i[o].material);
      a.push(l);
    }
    return a.push(e.loadGeometries(i)), Promise.all(a).then(function(o) {
      ...
      for (let h = 0, m = l.length; h < m; h++) {
        let T = l[h], p = i[h], g, _ = c[h];
        if (p.mode === E.TRIANGLES || p.mode === E.TRIANGLE_STRIP || p.mode === E.TRIANGLE_FAN || p.mode === void 0) g = s.isSkinnedMesh === true ? new Xo(T, _) : new ve(T, _), g.isSkinnedMesh === true && g.normalizeSkinWeights(), p.mode === E.TRIANGLE_STRIP ? g.geometry = R(g.geometry, Ku) : p.mode === E.TRIANGLE_FAN && (g.geometry = R(g.geometry, Qu));
        else if (p.mode === E.LINES) g = new kr(T, _);
        else if (p.mode === E.LINE_STRIP) g = new Ms(T, _);
        else if (p.mode === E.LINE_LOOP) g = new $o(T, _);
        else if (p.mode === E.POINTS) g = new Qo(T, _);
        else throw new Error("THREE.GLTFLoader: Primitive mode unsupported: " + p.mode);
        Object.keys(g.geometry.morphAttributes).length > 0 && Pt(g, s), g.name = e.createUniqueName(s.name || "mesh_" + t), M(g, s), p.extensions && D(n, g, p), e.assignFinalMaterial(g), u.push(g);
      }
      for (let h = 0, m = u.length; h < m; h++) e.associations.set(u[h], { meshes: t, primitives: h });
      if (u.length === 1) return s.extensions && D(n, u[0], s), u[0];
      let f = new Kn();
      s.extensions && D(n, f, s), e.associations.set(f, { meshes: t });
      for (let h = 0, m = u.length; h < m; h++) f.add(u[h]);
      return f;
    });
  }
  loadCamera(t) {
    ...
    return r.type === "perspective" ? e = new Ee(yd.radToDeg(n.yfov), n.aspectRatio || 1, n.znear || 1, n.zfar || 2e6) : r.type === "orthographic" && (e = new Ns(-n.xmag, n.xmag, n.ymag, -n.ymag, n.znear, n.zfar)), r.name && (e.name = this.createUniqueName(r.name)), M(e, r), Promise.resolve(e);
  }
  loadSkin(t) {
  ...
  loadAnimation(t) {
    let e = this.json, r = this, n = e.animations[t], s = n.name ? n.name : "animation_" + t, i = [], a = [], o = [], c = [], l = [];
    for (let u = 0, f = n.channels.length; u < f; u++) {
      let h = n.channels[u], m = n.samplers[h.sampler], T = h.target, p = T.node, g = n.parameters !== void 0 ? n.parameters[m.input] : m.input, _ = n.parameters !== void 0 ? n.parameters[m.output] : m.output;
      T.node !== void 0 && (i.push(this.getDependency("node", p)), a.push(this.getDependency("accessor", g)), o.push(this.getDependency("accessor", _)), c.push(m), l.push(T));
    }
    return Promise.all([Promise.all(i), Promise.all(a), Promise.all(o), Promise.all(c), Promise.all(l)]).then(function(u) {
      let f = u[0], h = u[1], m = u[2], T = u[3], p = u[4], g = [];
      for (let _ = 0, x = f.length; _ < x; _++) {
        let R2 = f[_], w = h[_], b = m[_], S = T[_], v = p[_];
        if (R2 === void 0) continue;
        R2.updateMatrix && R2.updateMatrix();
        let L = r._createAnimationTracks(R2, w, b, S, v);
        if (L) for (let q = 0; q < L.length; q++) g.push(L[q]);
      }
      return new ll(s, void 0, g);
    });
  }
  createNodeMesh(t) {
  ...
  loadNode(t) {
    let e = this.json, r = this, n = e.nodes[t], s = r._loadNodeShallow(t), i = [], a = n.children || [];
    for (let c = 0, l = a.length; c < l; c++) i.push(r.getDependency("node", a[c]));
  ...
  _loadNodeShallow(t) {
    ...
    return o && a.push(o), s.camera !== void 0 && a.push(n.getDependency("camera", s.camera).then(function(c) {
      ...
      let l;
      if (s.isBone === true ? l = new Or() : c.length > 1 ? l = new Kn() : c.length === 1 ? l = c[0] : l = new de(), l !== c[0]) for (let u = 0, f = c.length; u < f; u++) l.add(c[u]);
      if (s.name && (l.userData.name = s.name, l.name = i), M(l, s), s.extensions && D(r, l, s), s.matrix !== void 0) {
        let u = new kt();
  ...
  loadScene(t) {
    let e = this.extensions, r = this.json.scenes[t], n = this, s = new Kn();
    r.name && (s.name = n.createUniqueName(r.name)), M(s, r), r.extensions && D(e, s, r);
    let i = r.nodes || [], a = [];
    ...
    return Promise.all(a).then(function(o) {
      ...
      let c = (l) => {
        ...
        for (let [f, h] of n.associations) (f instanceof en || f instanceof Ae) && u.set(f, h);
        return l.traverse((f) => {
          let h = n.associations.get(f);
          h != null && u.set(f, h);
        }), u;
      };
  ...
  _createAnimationTracks(t, e, r, n, s) {
    ...
    let l = n.interpolation !== void 0 ? Ot[n.interpolation] : Ir, u = this._getArrayFromAccessor(r);
  ...
  _getArrayFromAccessor(t) {
    let e = t.array;
    if (t.normalized) {
      let r = ke2(e.constructor), n = new Float32Array(e.length);
...
function vt(d, t, e) {
  let r = t.attributes, n = new Ie();
  if (r.POSITION !== void 0) {
    let a = e.json.accessors[r.POSITION], o = a.min, c = a.max;
    if (o !== void 0 && c !== void 0) {
      if (n.set(new C(o[0], o[1], o[2]), new C(c[0], c[1], c[2])), a.normalized) {
        let l = ke2(B[a.componentType]);
  ...
  if (s !== void 0) {
    ...
    for (let c = 0, l = s.length; c < l; c++) {
      ...
      if (u.POSITION !== void 0) {
        let f = e.json.accessors[u.POSITION], h = f.min, m = f.max;
        if (h !== void 0 && m !== void 0) {
          if (o.setX(Math.max(Math.abs(h[0]), Math.abs(m[0]))), o.setY(Math.max(Math.abs(h[1]), Math.abs(m[1]))), o.setZ(Math.max(Math.abs(h[2]), Math.abs(m[2]))), f.normalized) {
            let T = ke2(B[f.componentType]);
            o.multiplyScalar(T);
          }
          a.max(o);
...
function Mt(d, t, e) {
  ...
  return Xt.workingColorSpace !== ni && "COLOR_0" in r && console.warn(`THREE.GLTFLoader: Converting vertex colors from "srgb-linear" to "${Xt.workingColorSpace}" not supported.`), M(d, t), vt(d, t, e), Promise.all(n).then(function() {
    return t.targets !== void 0 ? Dt(d, t.targets, e) : d;
  });
}
export {
  St as GLTFLoader
};
//# sourceMappingURL=GLTFLoader-TLLNLQ5Y-QHVCG2AU.js.map
