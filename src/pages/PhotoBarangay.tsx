...
export default function PhotoBarangay() {
    ...
    useEffect(() => {
        ...
        if (applicationData.barangayClearance) {
            ...
            const mockFile = new File([''], applicationData.barangayClearance.name, {
                type: applicationData.barangayClearance.type
            })
            setPhoto(mockFile)
        }
    }, [])
    ...
    const handlePhotoUpload = async (file: File) => {
        try {
            ...
            const result = await uploadPhoto(file, vendorApplicationId, 'barangay_clearance')
            ...
            if (result.success && result.url) {
                ...
                const applicationData = JSON.parse(localStorage.getItem('vendorApplicationData') || '{}')
                applicationData.barangayClearance = {
                    url: result.url,
                    name: file.name,
                    type: file.type,
                    preview: preview
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex-1 mx-4">
                            <div className="h-1 bg-gray-200 rounded">
                                <div className="h-1 bg-green-600 rounded" style={{ width: '50%' }}></div>
                            </div>
                        </div>
                        <div className="flex items-center">
                            <span className="text-sm font-medium text-gray-800">Barangay Clearance</span>
                            <div className="w-8 h-8 bg-gray-800 rounded-full flex items-center justify-center text-white text-sm font-semibold ml-2">3</div>
                        </div>
                        <div className="flex items-center">
                            ...
                            <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 sticky top-4">
                                ...
                                <ul className="space-y-2 text-gray-700">
                                    <li className="flex items-start">
                                        ...
                                        <span>Document must be original and valid</span>
                                    </li>
                                    <li className="flex items-start">
                                    ...
                                    <li className="flex items-start">
                                        ...
                                        <span>Document should be well-lit and in focus</span>
                                    </li>
                                    <li className="flex items-start">
                                ...
                                {preview ? (
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-gray-600 mb-4">Take a clear photo of your Barangay Clearance or upload an existing photo</p>
