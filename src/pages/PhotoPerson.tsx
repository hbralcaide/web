...
export default function PhotoPerson() {
    ...
    useEffect(() => {
        ...
        if (applicationData.personPhoto) {
            ...
            const mockFile = new File([''], applicationData.personPhoto.name, {
                type: applicationData.personPhoto.type
            })
            setPhoto(mockFile)
        }
    }, [])
    ...
    const handlePhotoUpload = async (file: File) => {
        try {
            ...
            const result = await uploadPhoto(file, vendorApplicationId, 'person_photo')
        ...
        try {
            ...
            if (navigator.mediaDevices && navigator.mediaDevices.getUserMedia) {
                ...
                const stream = await navigator.mediaDevices.getUserMedia({
                    video: { facingMode: 'user' } // Front camera for person photos
                })
    ...
    const handleNext = () => {
        ...
        // Normal application flow - Store photo data (in a real app, you'd upload to server)
        const applicationData = JSON.parse(localStorage.getItem('vendorApplicationData') || '{}')
        applicationData.personPhoto = {
            name: photo.name,
            size: photo.size,
        ...
        <div className="min-h-screen bg-gray-100">
            ...
            <div className="bg-gray-700 text-white py-2">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center space-y-2 sm:space-y-0">
                        <h1 className="text-lg sm:text-xl font-semibold">Step 2: Person Photo</h1>
                        <Link
                            to="/vendor-application/personal-info"
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex-1 mx-4">
                            <div className="h-1 bg-gray-200 rounded">
                                <div className="h-1 bg-green-600 rounded" style={{ width: '33.33%' }}></div>
                            </div>
                        </div>
                        <div className="flex items-center">
                            <span className="text-sm font-medium text-gray-800">Photo Person</span>
                            <div className="w-8 h-8 bg-gray-800 rounded-full flex items-center justify-center text-white text-sm font-semibold ml-2">2</div>
                        </div>
                        <div className="flex items-center">
            ...
            <div className="md:hidden bg-white border-b border-gray-200">
                <div className="max-w-4xl mx-auto px-4 py-3">
                    <div className="flex items-center justify-between">
                        <span className="text-sm font-medium text-gray-800">Step 2 of 6</span>
                        <div className="flex-1 mx-4">
                            <div className="h-2 bg-gray-200 rounded-full">
                                <div className="h-2 bg-green-600 rounded-full" style={{ width: '33.33%' }}></div>
                            </div>
                        </div>
                        <span className="text-sm text-gray-600">Photo Person</span>
                    </div>
                </div>
            </div>
            ...
            <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
                <div className="bg-white rounded-lg shadow-sm border border-gray-300 p-4 sm:p-8">
                    <div className="mb-6 sm:mb-8">
                        <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-2">Take Person Photo</h2>
                        <p className="text-gray-600">Please take a clear photo of the person applying for the vendor permit.</p>
                    </div>
                            ...
                            <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 sticky top-4">
                                ...
                                <ul className="space-y-2 text-gray-700">
                                    <li className="flex items-start">
                                        ...
                                        <span>Photo must be clear and well-lit</span>
                                    </li>
                                    <li className="flex items-start">
                                        ...
                                        <span>Person should be facing the camera directly</span>
                                    </li>
                                    <li className="flex items-start">
                                        ...
                                        <span>No hats, sunglasses, or face coverings</span>
                                    </li>
                                    <li className="flex items-start">
                                ...
                                {preview ? (
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-gray-600 mb-4">Take a clear photo of the person or upload an existing photo</p>
